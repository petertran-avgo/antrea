...
// testACNPClusterGroupNodeSelectorRule validates an ACNP with a rule containing a ClusterGroup with NodeSelector
func testACNPClusterGroupNodeSelectorRule(t *testing.T) {
...
func TestAntreaPolicy(t *testing.T) {
	...
	t.Run("TestGroupNoK8sNP", func(t *testing.T) {
		...
		t.Run("Case=ACNPClusterGroupNodeSelectorRule", func(t *testing.T) { testACNPClusterGroupNodeSelectorRule(t) })
